...
echo "select 'mkdir -p /home/'||login||'/home/'||login||'; chmod 755  /home/' || login ||'; mount -bind /sourcehome/'|| login || ' /home/'||login||'/home/'||login||';' as comd from sftpaccounts where login is not null and password is not null;">sql2
